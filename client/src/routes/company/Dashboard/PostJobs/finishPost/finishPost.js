    ...
    <div>
      <div className="parent-Container">
        ...
        <div className="finishPost-SubText">
          Your account was created and you&apos;re one step closer to hiring the
          workers you need. ou can now create a hub and manage candidates. Any
          job listings you create will activate once your organization is
          approved.
        </div>
        ...
        <div className="finishPost-review-sub">
          Once your organization is approved, your jobs will be visible to
        ...
        <div className="finishPost-review-sub">
          Once you’ve created a job, it’s time to start attracting candidates.
          Click the
          <br /> sponsorship button on your listing to set your budget and get
          your posting to the top
          <br /> of search results.
        </div>
        <div className="finishPost-Button-Container">
          <button className="finishPost-Continue-Button" onClick={NextPage}>
