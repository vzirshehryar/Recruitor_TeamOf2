      ...
      <div>
        <div className="parent-Container">
          ...
          <div className="finishPost-SubText">
            Your account was created and you&apos;re one step closer to hiring
            the workers you need. ou can now create a hub and manage candidates.
            Any job listings you create will activate once your organization is
            approved.
          </div>
