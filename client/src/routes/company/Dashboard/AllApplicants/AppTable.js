      ...
      <div className="container-app-search">
        <div className="rectangle-app-search">
          <div className="dropdown-appsearch">  
            <button className="filter-button-app-search" onClick={handleFilterClick}>
        ...
        <table className="custom-table">
          ...
          {currentItems
            ...
            <tr key={index}>
              ...
              <td>{new Date(applicant.appliedDate).toLocaleDateString('en-GB', { day: 'numeric', month: 'short', year: 'numeric' })}</td>
              <td>{applicant.jobRole}</td>
              <td><div className="stage-rectangle">{applicant.hiringStage}</div></td>
