...
export const CoverLetterView = () => {
 ...
 const { formData } = UserContextProvider1();
  ...
  <p>
          ...
          <ol>
            <li className="lst-h"><h4 className="lst-h">Two Copies of passport</h4></li>
            <li className="lst-h"><h4 className="lst-h">Two Copies of passport</h4></li>
            <li className="lst-h"><h4 className="lst-h">Two Copies of passport</h4></li>
            <li className="lst-h"><h4 className="lst-h">Two Copies of passport</h4></li>
          </ol>
      ...
      <div className="buttons-containerss111">
        <div className="cover-letter-view-template-button111">
          <Link to="/coverbuilder">
            <button className="cover-letter-back-button11">Change template</button></Link>
        </div>
        ...
        <div className="custom-cover-letter-button-container">
          <Link to="/coverletterform">
            <button className="cover-letter-back-button">BACK</button></Link>
          <Link to="/careercoach">
            <button className="cover-letter-next-button">SUBMIT</button></Link>
        </div>
        </div>
    </div>
  );
